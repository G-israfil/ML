# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 04:09:29 2023
...
num_trees = 100
bagging_model = BaggingClassifier(base_estimator=base_model, n_estimators=num_trees)
...
predictions = bagging_model.predict(dataTest1d)
